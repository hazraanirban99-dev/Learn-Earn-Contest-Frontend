...
const NewsletterCTA = () => {
    ...
    return (
        <section className="w-full py-16 sm:py-24 px-6 sm:px-12 bg-[#f8faf2] overflow-hidden">
            <div className="max-w-[900px] mx-auto">
                <div className="relative rounded-[40px] overflow-hidden shadow-2xl shadow-[#8cc63f]/10 border border-[#8cc63f]/10">
                    ...
                    <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-96 h-32 bg-white/30 blur-2xl rounded-full pointer-events-none" />
                    ...
                    <div className="relative z-10 flex flex-col lg:flex-row items-center gap-10 p-8 sm:p-12 lg:p-14">
                        ...
                        <div className="flex-shrink-0 relative w-28 h-28 sm:w-36 sm:h-36">
                            ...
                            {/* Floating badge 2 */}
                            <div className="absolute -bottom-2 -left-3 w-9 h-9 bg-white rounded-xl flex items-center justify-center shadow-md rotate-6 border border-[#8cc63f]/20">
                        ...
                        <div className="flex-1 text-center lg:text-left w-full">
                            {/* Eyebrow */}
                            <div className="inline-flex items-center gap-2 bg-white/70 border border-[#8cc63f]/20 rounded-full px-4 py-1.5 mb-4 shadow-sm backdrop-blur-sm">
                            ...
                            <h2 className="text-2xl sm:text-3xl lg:text-4xl font-black text-slate-900 tracking-tighter leading-tight mb-3">
                                ...
                                <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-3 w-full mx-auto lg:mx-0">
                                    <div className="relative flex-1">
                                        ...
                                        <input
                                            ...
                                            className="w-full pl-11 pr-4 py-4 rounded-2xl bg-white border-2 border-transparent focus:border-[#8cc63f]/40 outline-none text-sm font-semibold text-slate-700 placeholder:text-gray-300 shadow-sm transition-all"
                                        />
                                    </div>
                                    <button
                                        type="submit"
