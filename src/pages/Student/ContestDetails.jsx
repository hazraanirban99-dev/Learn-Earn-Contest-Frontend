...
const ContestDetails = () => {
        ...
        return (
            <div className="min-h-screen bg-[#f8faf2] dark:bg-gray-900 flex items-center justify-center">
                <div className="text-center">
                    <h2 className="text-2xl font-black text-slate-800 dark:text-gray-100 mb-4">Contest Not Found</h2>
    ...
    const ContestContent = (
        <div className={isAdmin ? 'px-0' : ''}>
            {/* --- SPLIT HEADER SECTION (50/50 Text/Image) --- */}
            <div className={`max-w-[1440px] mx-auto ${isAdmin ? 'px-0 pt-6 pb-8' : 'px-6 sm:px-12 lg:px-24 pt-12 pb-12'} flex flex-col md:flex-row gap-8 lg:gap-16 items-center`}>
                ...
                <div className="flex-1 lg:w-1/2">
                    ...
                    {/* Title */}
                    <h1 className="text-4xl md:text-5xl lg:text-6xl font-black text-slate-800 dark:text-gray-100 leading-[1.1] tracking-tight mb-8">
                        {contest.title}
                    </h1>
            ...
            <section className={`max-w-[1440px] mx-auto ${isAdmin ? 'px-0 pb-12' : 'px-6 sm:px-12 lg:px-24 pb-24'}`}>

                {/* --- ROW 1: PRIZES, TIMELINE, APPLY NOW (SIDE-BY-SIDE) --- */}
                <div className={`grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 ${isAdmin ? 'lg:gap-8 mb-10' : 'lg:gap-12 mb-16'} items-stretch`}>
                    ...
                    <div className="bg-gradient-to-br from-[#4a7010] to-[#2e4a07] p-8 lg:p-10 rounded-[40px] text-white overflow-hidden relative shadow-2xl shadow-[#4a7010]/20 min-h-[300px] flex flex-col justify-center">
                        ...
                        <div className="space-y-8 relative z-10">
                            ...
                            <div className={`flex items-start gap-4 ${contest.cashPrize > 0 ? 'opacity-100' : 'opacity-50'}`}>
                                <div className="w-10 h-10 rounded-full bg-white/ dark:bg-gray-800/ backdrop-blur-md flex items-center justify-center text-white shrink-0">
                    ...
                    <div className="bg-white dark:bg-gray-800 p-8 lg:p-10 rounded-[40px] text-center border-[3px] border-[#fbc111]/90 shadow-2xl shadow-[#fbc111]/10 flex flex-col justify-center">
                        ...
                        <div className="flex items-center justify-center gap-2 sm:gap-3 text-xl sm:text-2xl lg:text-3xl font-black text-slate-800 dark:text-gray-100 font-mono tracking-tighter mb-4">
                        ...
                        {isAdmin ? (
                            <div className="p-4 bg-blue-50/50 rounded-2xl border border-blue-100/50 text-center">
                                <p className="text-[10px] text-blue-500 font-black uppercase tracking-widest leading-none mb-2">Internal Preview</p>
                                <p className="text-gray-400 font-bold text-[11px] leading-relaxed">
                                    You are viewing this contest as an administrator. Enrollment actions are disabled.
                                </p>
                            </div>
                        ) : hasApplied || teamData ? (
                ...
                <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-center">
                    ...
                    <div className="bg-white dark:bg-gray-800 rounded-[40px] p-8 md:p-12 shadow-sm border border-gray-100 dark:border-gray-700 flex-1 lg:flex-[2]">
                        <h3 className="text-2xl font-black text-slate-800 dark:text-gray-100 mb-8">General Contest Rules</h3>
