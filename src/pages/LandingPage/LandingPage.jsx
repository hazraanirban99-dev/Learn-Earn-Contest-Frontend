...
const LandingPage = () => {
  ...
  // Handle smooth scroll when landing with a hash (from Login/Register)
  useEffect(() => {
          ...
          <div className="relative animate-in zoom-in duration-1000">
             ...
             <div className="relative bg-white p-3 rounded-[40px] shadow-2xl border border-white/50 overflow-hidden group">
                <img 
                  ...
                  className="w-full h-[280px] md:h-[400px] object-cover rounded-[32px] transition-all duration-1000 group-hover:scale-105"
                />
             </div>
          </div>
        </div>
              ...
              <div className="bg-white p-8 rounded-[40px] border border-gray-100 shadow-sm hover:shadow-xl transition-all flex flex-col justify-between">
                 <div>
                    <div className="flex items-center gap-4 mb-6">
                       <img src="https://i.pravatar.cc/150?img=60" className="w-12 h-12 rounded-full border-4 border-yellow-50 shadow-sm" alt="Dr. Artis Thorne" />
                       <div>
                          <h4 className="font-black text-slate-900 text-sm">Dr. Artis Thorne</h4>
                          <p className="text-[10px] text-gray-400 font-black uppercase tracking-widest leading-none">CAO</p>
                       </div>
                    </div>
                    <p className="text-slate-700 italic font-bold text-base leading-relaxed opacity-80">
                       "Our mission is to inspire the next generation of architects of the digital landscape."
                    </p>
                 </div>
                 <div className="mt-6 h-1 w-12 bg-[#fbc111] rounded-full shadow-sm"></div>
              </div>
